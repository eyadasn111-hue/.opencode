...
```bash
INIT=$(node "C:/Users/eyada/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/eyada/.opencode/get-shit-done/templates/spec.md.
