...
```
Task(
  prompt="Read C:/Users/eyada/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/eyada/.opencode/get-shit-done/templates/VALIDATION.md`
