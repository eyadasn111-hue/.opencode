...
<reference>
@C:/Users/eyada/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/eyada/.opencode/get-shit-done/references/user-profiling.md` to load:
